...
SEXP data__smd_curve_beta(SEXP curve, SEXP alpha, SEXP log);
SEXP data__smd_curve_epsilon(SEXP curve, SEXP delta, SEXP T_delta, SEXP log);
SEXP data__smd_curve_tradeoff(SEXP curve, SEXP num_approximations, SEXP T_num_approximations, SEXP log);
