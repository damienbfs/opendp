...
SEXP measurements__make_geometric(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP bounds, SEXP T, SEXP OptionT, SEXP log);
SEXP measurements__make_laplace(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP k, SEXP T_k, SEXP log);
...
SEXP measurements__make_randomized_response(SEXP categories, SEXP prob, SEXP constant_time, SEXP T, SEXP T_categories, SEXP log);
