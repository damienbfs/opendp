...
static R_CMethodDef R_CDef[] = {
    ...
    {"combinators__make_fix_delta", (DL_FUNC) &combinators__make_fix_delta, 3},
    ...
    {"measurements__make_geometric", (DL_FUNC) &measurements__make_geometric, 7},
    {"measurements__make_laplace", (DL_FUNC) &measurements__make_laplace, 6},
    {"measurements__make_laplace_threshold", (DL_FUNC) &measurements__make_laplace_threshold, 7},
    {"measurements__make_randomized_response", (DL_FUNC) &measurements__make_randomized_response, 6},
    {"measurements__make_randomized_response_bool", (DL_FUNC) &measurements__make_randomized_response_bool, 3},
    {"measurements__make_report_noisy_max_gumbel", (DL_FUNC) &measurements__make_report_noisy_max_gumbel, 5},
